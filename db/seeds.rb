...
theme1 = Theme.create({first_theme: "時間をはかる", second_theme: "水を飲む", third_theme: "姿勢に気を付ける", project_id: project2.id })
theme1 = Theme.create({first_theme: "時間をはかる", second_theme: "前日の夜はしっかりと寝る", third_theme: "姿勢に気を付ける", project_id: project2.id })
theme1 = Theme.create({first_theme: "時間を決めて、リラックスする", second_theme: "日記や覚え書きを書く", third_theme: "次読むものを決めておく", project_id: project1.id })
theme1 = Theme.create({first_theme: "最初のうちは殴り書きでもいいのでとにかく書く", second_theme: "回数を重ねる", third_theme: "書き終わったら数分でもよいので、まとめる時間を取る", project_id: project3.id })
theme1 = Theme.create({first_theme: "自分の好きなものを題材に選ぶ", second_theme: "時間を決めてその時間内で読めるところまで読む", third_theme: "読めない漢字はメモしておく", project_id: project4.id })
theme1 = Theme.create({first_theme: "ストレッチ", second_theme: "水を飲む", third_theme: "朝食を忘れない", project_id: project5.id })
